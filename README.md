...
Because I will be using the Android step counter sensor, [b]it will have more latency (7 seconds of movement until it starts recording), but more accuracy (higher chance of getting the correct number of steps)[/b].
